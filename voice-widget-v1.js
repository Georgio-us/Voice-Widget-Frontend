...
const LOCALES = {
  RU: {
    ...
    systemManagerHint: 'Вопрос вне подбора · можно уточнить у менеджера',
    systemContactManager: 'Связаться с менеджером',
  ...
  EN: {
    ...
    systemManagerHint: 'Question outside selection · contact manager',
    systemContactManager: 'Contact manager',
  ...
  ES: {
    ...
    systemManagerHint: 'Consulta fuera de selección · contactar con gerente',
    systemContactManager: 'Contactar con gerente',
